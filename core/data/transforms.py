...
class TwoCropsTransform:
    """Take two random crops of one image as the query and key. github.com/facebookresearch/moco"""
...
class GaussianBlur(object):
    """Gaussian blur augmentation in SimCLR. github.com/facebookresearch/moco"""
