...
from .lambda_scheduler import WCosCon
...
def scheduler_entry(config):
    if config.type in ['StepEpoch', 'CosineEpoch', 'eCosineEpoch', 'CosConEpoch', 'WCosConEpoch', 'CosNConEpoch',
                       'CosCon3Epoch', 'WCosCon2BnEpoch', 'WCosNConEpoch']:
