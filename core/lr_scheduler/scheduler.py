...
class CosineLREpochScheduler(_WarmUpLRScheduler):
    ...
    def _get_new_lr(self):
        ...
        last_epoch = self.last_iter // step_per_epoch
        warmup_epoch = round(self.warmup_steps / step_per_epoch)
        epoch_ratio = (last_epoch - warmup_epoch) / (self.max_epoch - warmup_epoch)
